...
export default function Home() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/cnn_background.jpg')" }}
    >
      <Head>
      ...
      <main className="flex-grow flex flex-col p-4 md:p-8 bg-white bg-opacity-80">
        <div className="flex flex-col items-center bg-black text-white p-4 rounded-lg mb-4">
          ...
          <h3 className="text-lg text-center">
            Real-Time Disaster Monitoring Platform that utilizes X stream data
            to dynamically monitor, predict, and display disasters and accidents
        ...
        {selectedEvent && (
          <div className="mt-4 bg-white bg-opacity-90 p-4 rounded-lg">
            ...
            <p>
              <strong>Latitude:</strong> {selectedEvent.geo.latitude}
            </p>
            <p>
              <strong>Longitude:</strong> {selectedEvent.geo.longitude}
            </p>
            <p>
              <strong>Emergency Level:</strong> {selectedEvent.emergency_level}
            </p>
            <p>
              <strong>Created At:</strong> {selectedEvent.created_at}
            </p>
          </div>
        )}
      </main>
